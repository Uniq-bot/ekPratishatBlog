                ...
                <td className="px-4 py-4">
                  <div className="flex flex-wrap gap-2">
                    {blog.tags?.map((tag: any) => (
                      <span key={tag.id} className="px-3 py-1 rounded-full text-sm bg-green-100">
                        {tag.name}
                      </span>
                    ))}
                  </div>
                ...
                <td className="px-4 py-4">
                  <div className="flex justify-center gap-2">
                    <button
                      ...
                      className="p-2 bg-white transition-all cursor-pointer border hover:bg-gray-100"
                      title="Edit"
                    >
                      <Edit size={18} />
                    </button>
                    <button
                      ...
                      className="p-2 border bg-white transition-all cursor-pointer hover:bg-red-500 hover:text-white disabled:opacity-50"
                      title="Delete"
                    >
                      <Trash size={18} />
                    </button>
