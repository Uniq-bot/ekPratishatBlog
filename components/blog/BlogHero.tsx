...
const BlogHero = () => {
  return (
    <div className="w-full top-0 left-0 right-0 absolute z-5  lg:h-120 h-50 shadow-md shadow-black md:relative">
            ...
            <div className="absolute  z-10 lg:bottom-5  md:transform md:-translate-y-1/2 lg:-translate-y-0 text-white p-5 ">
                <h1 className="lg:text-5xl text-xl  lg:pr-50 lg:leading-15">
