...
const Footer = () => {
  ...
  return (
    <div className="bg-[#1F1B16] w-full lg:h-screen text-white">
      ...
      <section className="sticky flex items-center lg:h-1/2 bottom-0 z-0 min-h-105 max-sm:min-h-120 lg:min-h-80 overflow-hidden bg-[linear-gradient(160deg,#fffaf0_0%,#f7f0df_58%,#eadcc4_100%)] text-[#241D12]">
        ...
        <div className="relative z-10 mx-auto flex min-h-105 max-sm:min-h-120 lg:min-h-95 w-full max-w-375 flex-col justify-between gap-6 px-4 pt-10 pb-6 sm:gap-8 sm:px-6 sm:pt-14 sm:pb-8 lg:px-8">
          <div className="flex items-center gap-3 justify-between sm:gap-4">
           <div>
            ...
            <h2 className="max-w-3xl text-[2.4rem] font-black leading-[1.02] tracking-tight text-[#241D12] sm:text-xl sm:leading-[1.05]">
              Stories, insights &{" "}
            ...
            <div className="mt-8 w-1/2 grid grid-cols-2 gap-x-5 gap-y-8 sm:grid-cols-4 sm:gap-x-6 justify-items-center text-center">
          ...
          <div className="grid gap-4 border-t border-[#D9C89A] pt-5 sm:gap-6 lg:grid-cols-[auto_1fr_auto] lg:items-center">
            ...
            <div className="flex flex-wrap gap-x-2.5 gap-y-1.5 text-xs font-bold leading-5 text-[#5C4E30] sm:gap-x-3 sm:gap-y-2 lg:justify-end">
              ...
              <Link href="#" className="hover:text-[#9A6A00]">
                Privacy
              </Link>
              <span>·</span>
              <Link href="#" className="hover:text-[#9A6A00]">
